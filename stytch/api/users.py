...
class Users(Base):
    ...
    def create(self, email: str, first_name: str, last_name: str, attributes: Dict[str, str] = None):
    ...
    def update(self, email: str, first_name: str, last_name: str, attributes: Dict[str, str]):
        data = {}
        if email:
