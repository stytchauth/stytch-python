...
from stytch.models.multi_tenant_session_service import (
    MultitenantauthenticateResponse,
    MultitenantgetResponse,
...
class MultiTenantSessionService:
    ...
    def MultiTenantget(
        ...
        return MultitenantgetResponse.from_json(res.response.status_code, res.json)

    async def MultiTenantget_async(
        self,
        organization_id: str,
        member_id: str,
    ) -> MultitenantgetResponse:
        ...
        return MultitenantgetResponse.from_json(res.response.status, res.json)

    def MultiTenantauthenticate(
        self,
        ...
        return MultitenantauthenticateResponse.from_json(
            res.response.status_code, res.json
        )

    async def MultiTenantauthenticate_async(
        self,
        session_token: Optional[str] = None,
        session_duration_minutes: Optional[int] = None,
        session_jwt: Optional[str] = None,
        ...
        return MultitenantauthenticateResponse.from_json(res.response.status, res.json)
