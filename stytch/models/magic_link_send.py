...
class MagicLinkSend(object):
    ...
    def __init__(self, user_id=None, method_id=None, magic_link_url=None, expiration_minutes=None, template_id=None, attributes=None, local_vars_configuration=None):  # noqa: E501
        """MagicLinkSend - a model defined in OpenAPI"""  # noqa: E501
    ...
    def method_id(self, method_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and method_id is None:  # noqa: E501
    ...
    def expiration_minutes(self):
        """Gets the expiration_minutes of this MagicLinkSend.  # noqa: E501
        ...
        :return: The expiration_minutes of this MagicLinkSend.  # noqa: E501
        :rtype: int
        """
    ...
    def expiration_minutes(self, expiration_minutes):
        """Sets the expiration_minutes of this MagicLinkSend.

        Set the expiration for the email magic link, in minutes. By default, it expires in 1 hour. The minimum expiration is 5 minutes and the maximum is 7 days (10080 mins).  # noqa: E501

        :param expiration_minutes: The expiration_minutes of this MagicLinkSend.  # noqa: E501
        :type: int
        """
