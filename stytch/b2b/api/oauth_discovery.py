...
class Discovery:
    ...
    def authenticate(
        ...
        Fields:
          - discovery_oauth_token: The discovery OAuth token from the `?token=` query parameter in the URL. This token is used to authenticate a Member via OAuth in a Discovery flow.
