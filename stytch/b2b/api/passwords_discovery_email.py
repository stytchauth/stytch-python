...
class Email:
    ...
    def reset_start(
        ...
        Fields:
          ...
          - reset_password_redirect_url: The URL that the Member is redirected to from the reset password magic link. This URL should display your application's reset password page.
